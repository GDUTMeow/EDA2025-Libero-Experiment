...
一、参考4.2.5 modelsim（部分操作需参考 5.5.1）的使用，自行编写“复合电路”（需求参考第2章P47）的代码和测试平台，并进行仿真。[代码](./ExpP7/2-3.v)
...
按照微助教内[PDF](./ExpP6/Libero-SoC-Fully-Design-Manual.pdf)文件流程操作一遍，烧录并测试
